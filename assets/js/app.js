...
function cargarInfo(e) {
    ...
    if (e.target.classList.contains('playEstudiar')) {
        ...
        descripcionPlay = 'La mejor playlist para estudiar';
        srcImg = 'assets/img/study.jpg';
        album.style.background = "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(assets/img/study.jpg)";
